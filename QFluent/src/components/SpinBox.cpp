...
SpinButton::SpinButton(Icon::IconType iconType, QWidget* parent)
    : QToolButton(parent), m_iconType(iconType) {
    setFixedSize(sizeHint());
    setCursor(Qt::ArrowCursor);

    setFixedSize(31, 23);
    setIconSize(QSize(10, 10));
    sTheme->registerWidget(this, Theme::StyleSheetType::SPIN_BOX);
}
...
void SpinButton::paintEvent(QPaintEvent* e) {
    ...
    Icon::drawSvgIcon(&painter, m_iconType, QRectF(10, 6.5, 11, 11));
}
...
void SpinBoxBase::setupStyle() {
    ...
    sTheme->registerWidget(m_parentWidget, Theme::StyleSheetType::SPIN_BOX);
...
void SpinBoxBase::addUpDownButtons() {
    ...
    m_upButton = new SpinButton(Icon::IconType::UP, m_parentWidget);
    m_downButton = new SpinButton(Icon::IconType::DOWN, m_parentWidget);
...
void SpinBoxBase::drawFocusBorder(QPainter* painter, const QRect& rect) {
    ...
    painter->fillPath(path, sTheme->themeColor());
}
