...
void ExpandSettingCard::initWidget() {
    ...
    sTheme->registerWidget(m_card, Theme::StyleSheetType::EXPAND_SETTING_CARD);
    sTheme->registerWidget(this, Theme::StyleSheetType::EXPAND_SETTING_CARD);
