...
QColor IndeterminateProgressRing::lightBarColor() const
{
    ...
    return sTheme->themeColor(Theme::ThemeColorType::LIGHT_1);
}
...
QColor IndeterminateProgressRing::darkBarColor() const
{
    ...
    return sTheme->themeColor(Theme::ThemeColorType::DARK_1);
}
...
void IndeterminateProgressRing::paintEvent(QPaintEvent *event)
{
    ...
    QColor bc = sTheme->isDarkMode() ? darkBackgroundColor : lightBackgroundColor;
    ...
    QColor barColor = sTheme->isDarkMode() ? darkBarColor() : lightBarColor();
