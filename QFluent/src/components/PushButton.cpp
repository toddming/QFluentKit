...
PushButton::PushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
...
void PushButton::initialize()
{
    ...
    m_iconType = Icon::IconType::NONE;

    setProperty("hasIcon", false);

    sTheme->registerWidget(this, Theme::StyleSheetType::BUTTON);
...
void PushButton::setButtonIcon(const Icon::IconType iconType)
{
    m_iconType = iconType;

    // 更新样式属性
    setProperty("hasIcon", iconType != Icon::IconType::NONE);
    style()->unpolish(this);
    style()->polish(this);
    update();
}

Icon::IconType PushButton::buttonIcon() const
{
    return m_iconType;
}
...
void PushButton::paintEvent(QPaintEvent *e)
{
    ...
    if (m_iconType == Icon::IconType::NONE)
        return;
...
PrimaryPushButton::PrimaryPushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
...
TransparentPushButton::TransparentPushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
...
HyperlinkButton::HyperlinkButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
    PushButton(text, parent)
{
    setProperty("hasIcon", iconType != Icon::IconType::NONE);
}
...
ToggleButton::ToggleButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
    PushButton(text, parent)
{
    setProperty("hasIcon", iconType != Icon::IconType::NONE);
    postInit();
...
TransparentTogglePushButton::TransparentTogglePushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
...
DropDownButtonBase::DropDownButtonBase(const QString &text, QWidget *parent, const Icon::IconType iconType)
    : PushButton(text, parent, iconType)
    , m_menu(nullptr)
    , m_arrowAni(new TranslateYAnimation(this))
{
...
void DropDownButtonBase::drawDropDownIcon(QPainter* painter, const QRectF& rect)
{
    if (sTheme->isDarkMode()) {
        Icon::drawSvgIcon(painter, Icon::IconType::ARROW_DOWN, rect);
    } else {
        QMap<QString, QString> attrs;
        attrs["fill"] = "#646464";
        Icon::drawSvgIcon(painter, Icon::IconType::ARROW_DOWN, rect, attrs);
    }
}
...
DropDownPushButton::DropDownPushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
...
TransparentDropDownPushButton::TransparentDropDownPushButton(const QString &text, QWidget *parent, const Icon::IconType iconType) :
