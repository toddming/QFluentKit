...
ToolButton::ToolButton(Icon::IconType icon, QWidget* parent)
    : ToolButton(parent)
{
    setIcon(icon);
}
...
void ToolButton::setIcon(Icon::IconType icon)
{
    m_iconType = icon;
    update();
}
...
void ToolButton::paintEvent(QPaintEvent* event)
{
    ...
    if (m_iconType == Icon::IconType::NONE && m_baseName.isEmpty()) {
        return;
    }
