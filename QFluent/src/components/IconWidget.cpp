...
IconWidget::IconWidget(Icon::IconType icon, QWidget *parent)
    : IconWidget(parent)
{
    setIcon(icon);
}
...
void IconWidget::setIcon(const QIcon &icon)
{
    ...
    m_fluentIcon = Icon::IconType::NONE;
    update();
}
...
void IconWidget::setIcon(Icon::IconType icon)
{
    m_fluentIcon = icon;
    m_isFluentIcon = true;
    m_icon = QIcon();
...
void IconWidget::paintEvent(QPaintEvent *event)
{
    ...
    if (m_isFluentIcon && (m_fluentIcon != Icon::IconType::NONE)) {
