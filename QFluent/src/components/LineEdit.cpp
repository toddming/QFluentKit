...
LineEditButton::LineEditButton(const QIcon& icon, QWidget* parent)
    ...
    sTheme->registerWidget(this, Theme::StyleSheetType::LINE_EDIT);
}
...
LineEdit::LineEdit(QWidget* parent) 
    : QLineEdit(parent),
      ...
      m_clearButton(new LineEditButton(Icon::FluentIcon(Icon::IconType::CLOSE), this)),
...
void SearchLineEdit::initWidgets()
{
    ...
    searchButton = new LineEditButton(Icon::FluentIcon(Icon::IconType::SEARCH), this);
