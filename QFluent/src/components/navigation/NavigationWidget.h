...
class NavigationPushButton : public NavigationWidget {
    Q_OBJECT
public:
    NavigationPushButton(Icon::IconType icon, const QString& text, bool isSelectable, QWidget* parent = nullptr);
...
class NavigationToolButton : public NavigationPushButton {
    Q_OBJECT
public:
    NavigationToolButton(Icon::IconType icon, QWidget* parent = nullptr);
...
public:
    NavigationTreeItem(Icon::IconType icon, const QString& text, bool isSelectable, NavigationTreeWidget* parent = nullptr);
...
class NavigationTreeWidget : public NavigationTreeWidgetBase {
    Q_OBJECT
public:
    NavigationTreeWidget(Icon::IconType icon, const QString& text, bool isSelectable, QWidget* parent = nullptr);
