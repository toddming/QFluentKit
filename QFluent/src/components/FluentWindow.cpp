...
void FluentWindow::loadStyleSheet(bool dark) {
    ...
    sTheme->setThemeMode(!dark ? Theme::ThemeType::LIGHT : Theme::ThemeType::DARK);
}
...
void FluentWindow::initUI()
{
    ...
    combo2->addItem("木星上行", Icon::FluentIcon(Icon::IconType::BRUSH), 1);
    combo2->addItem("星际穿越", Icon::FluentIcon(Icon::IconType::GAME), 2);
    combo2->addItem("我是传奇", Icon::FluentIcon(Icon::IconType::LABEL), 3);

    lay->addWidget(combo2);

    PushButton *btn = new PushButton("PushButton", this, Icon::IconType::HOME);
    lay->addWidget(btn);
    ...
    ToggleToolButton *tool = new ToggleToolButton(Icon::IconType::WIFI, this);
    lay->addWidget(tool);

    lay->addWidget(new ToolButton(Icon::IconType::WIFI, this));
    ...
    menu->addAction(new Action(Icon::FluentIcon(Icon::IconType::SEND), "Send"));
    menu->addAction(new Action(Icon::FluentIcon(Icon::IconType::EDUCATION), "Exit"));

    DropDownPushButton *dropBtn = new DropDownPushButton("Menu", this, Icon::IconType::MENU);
    ...
    sTheme->registerWidget(stacked, Theme::StyleSheetType::FLUENT_WINDOW);
    ...
    PrimaryPushSettingCard *feedbackCard = new PrimaryPushSettingCard("Provide feedback",
                                                                      Icon::FluentIcon(Icon::IconType::FEEDBACK),
                                                                      "Provide feedback",
                                                                      "Help us improve PyQt-Fluent-Widgets by providing feedback",
                                                                      aboutGroup);
    SwitchSettingCard *updateOnStartUpCard = new SwitchSettingCard(Icon::FluentIcon(Icon::IconType::UPDATE),
                                                                   "Check for updates when the application starts",
                                                                   "The new version will be more stable and have more features",
                                                                   aboutGroup);

    HyperlinkCard *helpCard = new HyperlinkCard("", "Open help page", Icon::FluentIcon(Icon::IconType::HELP),
                                                "Help",
    ...
    ComboBoxSettingCard *languageCard = new ComboBoxSettingCard({"简体中文", "繁體中文", "English", "系统设置"},
                                                                Icon::FluentIcon(Icon::IconType::LANGUAGE),
                                                                "Language",
                                                                "Set your preferred language for UI",
                                                                aboutGroup);
    OptionsSettingCard *zoomCard = new OptionsSettingCard(Icon::FluentIcon(Icon::IconType::ZOOM),
                                                          "Interface zoom",
    ...
    panel->addItem("1", Icon::IconType::HOME, "主页", [=](){switchTo(wids[0]);}, true, NavigationItemPosition::TOP);
    panel->addSeparator();
    panel->addItem("2", Icon::IconType::CHECKBOX, "基本输入", [=](){switchTo(wids[1]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("3", Icon::IconType::DATE_TIME, "日期和时间", [=](){switchTo(wids[2]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("4", Icon::IconType::MESSAGE, "弹出窗口", [=](){switchTo(wids[3]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("5", Icon::IconType::LAYOUT, "布局", [=](){switchTo(wids[4]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("6", Icon::IconType::PALETTE, "材料", [=](){switchTo(wids[5]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("7", Icon::IconType::WIFI, "网络", [=](){switchTo(wids[6]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("8", Icon::IconType::SCROLL, "布局", [=](){switchTo(wids[7]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("9", Icon::IconType::CHAT, "信息", [=](){switchTo(wids[8]);}, true, NavigationItemPosition::SCROLL);
    panel->addItem("10", Icon::IconType::EMOJI_TAB_SYMBOLS, "图标", [=](){switchTo(wids[9]);}, true, NavigationItemPosition::SCROLL);

    panel->addSeparator(NavigationItemPosition::BOTTOM);
    panel->addItem("11", Icon::IconType::SETTING, "设置", [=](){switchTo(wids[10]);}, true, NavigationItemPosition::BOTTOM);



    auto *navBar = new NavigationBar(this);
    navBar->addItem("1", Icon::IconType::HOME, "主页", nullptr, true, Icon::IconType::HOME, NavigationItemPosition::TOP);
    navBar->addSeparator();
    navBar->addItem("2", Icon::IconType::CHECKBOX, "输入", nullptr, true, Icon::IconType::CHECKBOX, NavigationItemPosition::SCROLL);
    navBar->addItem("3", Icon::IconType::DATE_TIME, "日期", nullptr, true, Icon::IconType::DATE_TIME, NavigationItemPosition::SCROLL);
    navBar->addItem("4", Icon::IconType::MESSAGE, "信息框", nullptr, true, Icon::IconType::MESSAGE, NavigationItemPosition::SCROLL);
    navBar->addSeparator(NavigationItemPosition::BOTTOM);
    navBar->addItem("5", Icon::IconType::SETTING, "设置", nullptr, true, Icon::IconType::SETTING, NavigationItemPosition::BOTTOM);
    ...
    pivot->addItem("1", " 主页", Icon::FluentIcon(Icon::IconType::HOME));
    pivot->addItem("2", " 订阅", Icon::FluentIcon(Icon::IconType::BOOK_SHELF));
    pivot->addItem("3", " 历史", Icon::FluentIcon(Icon::IconType::HISTORY));
