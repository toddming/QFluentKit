        ...
        if (const QStyleOptionSlider* sopt = qstyleoption_cast<const QStyleOptionSlider*>(option))
        {
            ...
            if (m_isExpand)
            {
                ...
                if (sopt->orientation == Qt::Horizontal)
                {
                    ...
                    // 左三角
                    Icon::drawSvgIcon(painter, IconType::FLuentIcon::CARE_LEFT_SOLID, leftIndicatorRect, attrs);

                    // 右三角
                    Icon::drawSvgIcon(painter, IconType::FLuentIcon::CARE_RIGHT_SOLID, rightIndicatorRect, attrs);
                } else {
                    ...
                    // 上三角
                    Icon::drawSvgIcon(painter, IconType::FLuentIcon::CARE_UP_SOLID, upIndicatorRect, attrs);

                    // 下三角
                    Icon::drawSvgIcon(painter, IconType::FLuentIcon::CARE_DOWN_SOLID, downIndicatorRect, attrs);
