...
void LoginWidget::userLogin()
{
    ...
    if (user.isEmpty()) {
        InfoBar::warning("警告", "用户名不能为空", Qt::Horizontal, false, 2000, InfoBar::Position::TOP, this);
        return;
    }
    if (pass.isEmpty()) {
        InfoBar::warning("警告", "密码不能为空", Qt::Horizontal, false, 2000, InfoBar::Position::TOP, this);
        return;
    }
    ...
    QTimer::singleShot(3000, this, [=](){
        loading(false);
        InfoBar::success("提示", "登录成功", Qt::Horizontal, false, 2000, InfoBar::Position::TOP, this);
    });
}
