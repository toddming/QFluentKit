    ...
    : GalleryInterface("状态", "", parent)
{
    ...
    connect(btn1, &PushButton::clicked, this, [=](){
        InfoBar::info("你看", "我有几分像从前?", Qt::Horizontal, false, 2000, Fluent::BarPosition::TOP_RIGHT, this);
    });
    connect(btn2, &PushButton::clicked, this, [=](){
        InfoBar::success("你看", "我有几分有几分有几分有几分有几分有几分有几分有几分有几分有几分有几分有几分有几分有几分"
                         ...
                         Qt::Horizontal, true, 2000, Fluent::BarPosition::TOP, this);
    });
    connect(btn3, &PushButton::clicked, this, [=](){
        InfoBar::warning("你看", "我有几分像从前?", Qt::Horizontal, false, 2000, Fluent::BarPosition::TOP_LEFT, this);
    });
    connect(btn4, &PushButton::clicked, this, [=](){
        InfoBar::error("你看", "我有几分像从前?", Qt::Horizontal, false, 2000, Fluent::BarPosition::BOTTOM_RIGHT, this);
    });
    connect(btn5, &PushButton::clicked, this, [=](){
        InfoBar::success("你看", "我有几分像从前?", Qt::Horizontal, false, 2000, Fluent::BarPosition::BOTTOM, this);
    });
    connect(btn6, &PushButton::clicked, this, [=](){
        InfoBar::warning("你看", "我有几分像从前?", Qt::Horizontal, false, 2000, Fluent::BarPosition::BOTTOM_LEFT, this);
    });
